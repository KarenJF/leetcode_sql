...
active_rides as (
    select 
        ...
        count(distinct a.driver_id) as active_driver
    from Rides r
...
select 
    d.month,
    round(ifnull(active_driver/driver_cnt,0)*100,2) as working_percentage
from active_driver_tb d
left join active_rides a
on d.month = a.month